...
<head>\
  ...
  <title>5 Mistakes Developers make Selling to Developers</title>\
...
\
     <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border: 1px solid #cccccc; border-collapse: collapse; box-shadow: 0px 7px 15px 8px #aaaaaa;">\
        <tr>\
          <td align="center" bgcolor="#70bbd9" style="padding: 0px 0 0px 0;">\
            <img src="images/article4.jpg" alt="5 Mistakes Developpers do" width="600" height="250" style="display: block;"/>\
          </td>\
        </tr>\
\
        <tr>\
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%">\
             <tr>\
               <td style="color: #153643; font-family: Arial, sans-serif; font-size: 24px;">\
                <b>5 Mistakes Developers make Selling to Developers</b>\
               </td>\
             </tr>\
\
             <tr>\
             ...
             <tr>\
              <td>\
               <table border="0" cellpadding="0" cellspacing="0" width="100%">\
                <!--<tr>\
                 <td>\
                  <img src="images/quantum.jpg" alt="" width="100%" height="200" style="display: block;" />\
                 </td>\
               </tr>-->\
\
                <tr>\
                 <td style="color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px; padding: 0 0 0 0;">\
\
                  <center>\
                  <img src="images/overselling.png" alt="" width="60px" height="60px" style="display: block;" />\
                  </center>\
                  <h3>Overselling</h3>\
                  <p align="justify">\
...
\
                  <br>\
                  <center>\
                  <img src="images/roadblocks.png" alt="" width="60px" height="60px" style="display: block;" />\
                  </center>\
...
\
                  <br>\
                  <center>\
                  <img src="images/order.png" alt="" width="60px" height="60px" style="display: block;" />\
                  </center>\
                  <h3>We get it.  You’re smart. We’re smart. Now about the order?</h3>\
                  <p align="justify">\
...
\
                  <br>\
                  <center>\
                  <img src="images/responsive.png" alt="" width="60px" height="60px" style="display: block;" />\
                  </center>\
                  <h3>Be responsive. </h3>\
                  <p align="justify">\
...
\
                  <br>\
                  <center>\
                  <img src="images/communicate.png" alt="" width="60px" height="60px" style="display: block;" />\
                  </center>\
                  <h3>Communicate</h3>\
                  <p align="justify">\
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%">\
             <tr>\
              <td style="color: #ffffff; font-family: Arial, sans-serif; font-size: 14px;">\
               &reg; <a href="http://fr.gravatar.com/bobwalsh47hats" style="color: #ffffff;"><font color="#ffffff">Bob Walsh</font></a>, <a href="https://www.47hats.com/" style="color: #ffffff;"><font color="#ffffff">47Hats</font></a>, 4 aug. 2010<br/>\
               Click <a href="https://www.47hats.com/2010/08/04/5-mistakes-developers-make-selling-to-developers/" style="color: #ffffff;"><font color="#ffffff">here</font></a> to read the original article\
              </td>\
              <td align="right">\
...
\
   <tr>\
     ...
     <a>\
      <div class="button" style="cursor: pointer;" onclick="window.location.href=\'quiz-5-mistakes-developers-do.html\'">\
        Passer au quiz <span class="shift">›</span>\
