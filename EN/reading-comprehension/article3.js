...
\
 <head>\
  ...
  <title>What would a million cigarettes cost? Health Canada wants to know</title>\
     ...
     <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border: 1px solid #cccccc; border-collapse: collapse; box-shadow: 0px 7px 15px 8px #aaaaaa;">\
        <tr>\
          <td align="center" bgcolor="#70bbd9" style="padding: 0px 0 0px 0;">\
            <img src="images/article3.png" alt="Cigarets Canada Health" width="600" height="250" style="display: block;" />\
          </td>\
        </tr>\
\
        <tr>\
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%">\
             <tr>\
               <td style="color: #153643; font-family: Arial, sans-serif; font-size: 24px;">\
                <b>What would a million cigarettes cost? Health Canada wants to know</b>\
               </td>\
             </tr>\
\
             <tr>\
              <td style="color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px; padding: 10px 0 0 0;">\
                <p align="justify"><i>\
                 ...
                 <tr>\
                  <td width="260" valign="top">\
                   <table border="0" cellpadding="0" cellspacing="0" width="100%">\
                    <!-- <tr>\
                     <td>\
                      <img src="images/default.png" alt="" width="100%" height="140" style="display: block;" />\
                     </td>\
                    </tr>-->\
\
                    <tr>\
...
\
                      <h3>\'Like marijuana without the THC\'</h3>\
                      <p align="justify">\
                  ...
                  <td width="260" valign="top">\
                   <table border="0" cellpadding="0" cellspacing="0" width="100%">\
                    <tr>\
                     <td>\
                      <img src="images/health-canada.jpg" alt="" width="100%" height="140" style="display: block;" />\
                     </td>\
                    </tr>\
\
                    <tr>\
...
\
                       <h3>Invest the money in cessation programs: Cancer Society</h3>\
                       <p align="justify">\
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%">\
             <tr>\
              <td style="color: #ffffff; font-family: Arial, sans-serif; font-size: 14px;">\
                &reg; Susan Lunn, <a href="http://www.cbc.ca/news" style="color: #ffffff;"><font color="#ffffff">CBC News</font></a>, 3 feb. 2018<br/>\
                Click <a href="http://www.cbc.ca/news/politics/what-would-a-million-cigarettes-cost-health-canada-wants-to-know-1.4517203" style="color: #ffffff;"><font color="#ffffff">here</font></a> to read the original article\
               </td>\
              <td align="right">\
...
\
   <tr>\
     ...
     <a>\
      <div class="button" style="cursor: pointer;" onclick="window.location.href=\'quiz-cigarets-health-canada.html\'">\
